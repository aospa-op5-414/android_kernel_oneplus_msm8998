...
static struct freq_tbl ftbl_gfx3d_clk_src[] = {
	F_GFX( 180000000, P_GPU_CC_PLL0_OUT_EVEN, 1, 1, 2,  360000000),
	F_GFX( 257000000, P_GPU_CC_PLL0_OUT_EVEN, 1, 1, 2,  514000000),
	F_GFX( 342000000, P_GPU_CC_PLL0_OUT_EVEN, 1, 1, 2,  684000000),
	F_GFX( 414000000, P_GPU_CC_PLL0_OUT_EVEN, 1, 1, 2,  828000000),
	F_GFX( 515000000, P_GPU_CC_PLL0_OUT_EVEN, 1, 1, 2, 1030000000),
	F_GFX( 596000000, P_GPU_CC_PLL0_OUT_EVEN, 1, 1, 2, 1192000000),
	F_GFX( 670000000, P_GPU_CC_PLL0_OUT_EVEN, 1, 1, 2, 1340000000),
	F_GFX( 710000000, P_GPU_CC_PLL0_OUT_EVEN, 1, 1, 2, 1420000000),
	{ }
};
